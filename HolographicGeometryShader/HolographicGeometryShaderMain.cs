...
using HolographicGeometryShader.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using HolographicGeometryShader.Content;
#endif

namespace HolographicGeometryShader
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class HolographicGeometryShaderMain : IDisposable
    {

#if DRAW_SAMPLE_CONTENT
        // Renders a colorful holographic cube that's 20 centimeters wide. This sample content
        // is used to demonstrate world-locked rendering.
        private GPUParticleSystemRenderer   gpuParticleSystemRenderer;
        ...
        public void SetHolographicSpace(HolographicSpace holographicSpace)
        {
            ...
            gpuParticleSystemRenderer = new GPUParticleSystemRenderer(deviceResources);
        ...
        {
#if DRAW_SAMPLE_CONTENT
            if (gpuParticleSystemRenderer != null)
            {
                gpuParticleSystemRenderer.Dispose();
                gpuParticleSystemRenderer = null;
            }
#endif
        }
        ...
        public HolographicFrame Update()
        {
            ...
            if (null != pointerState)
            {
                ...
                gpuParticleSystemRenderer.PositionHologram(
...
#if DRAW_SAMPLE_CONTENT
                gpuParticleSystemRenderer.Update(timer);
#endif
            });
            ...
            foreach (var cameraPose in prediction.CameraPoses)
            {
                ...
                renderingParameters.SetFocusPoint(
                    ...
                    gpuParticleSystemRenderer.Position
                    );
#endif
            }
                ...
                (Dictionary<uint, CameraResources> cameraResourceDictionary) =>
            {
                ...
                foreach (var cameraPose in prediction.CameraPoses)
                {
                    ...
                    if (cameraActive)
                    {
                        ...
                        gpuParticleSystemRenderer.Render();
                    }
#endif
...
#if DRAW_SAMPLE_CONTENT
            gpuParticleSystemRenderer.ReleaseDeviceDependentResources();
#endif
        ...
        {
#if DRAW_SAMPLE_CONTENT
            gpuParticleSystemRenderer.CreateDeviceDependentResourcesAsync();
#endif
        }
