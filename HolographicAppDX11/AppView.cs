...
using HolographicAppDX11.Common;
using System.Diagnostics;

namespace HolographicAppDX11
{
    /// <summary>
    ...
    {
        private HolographicAppDX11Main main;
        ...
        public void Initialize(CoreApplicationView applicationView)
        {
            ...
            main = new HolographicAppDX11Main(deviceResources);
        }
        ...
        private async void GetSystemInformations(String uri)
        {
        ...
        {
            var uri = "http://169.254.204.101/api/app/packagemanager/packages";

            GetSystemInformations(uri);
        }
